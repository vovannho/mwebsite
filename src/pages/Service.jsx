...
const Service = () => {
  ...
  return (
    <div>
        ...
        <ul className='lg:grid grid-cols-2 gap-6 mt-6'>
              {Services.map((item,index)=> {
                    return(
                        <li className='relative grid grid-cols-2 gap-3 border p-3 shadow-md min-h-[310px]' key={index}>
                          <div>
                          ...
                          <div>
                            ...
                            <div className='float-right items-end mt-3'>
                              <Button text='Call Now' variant='green' icon={<FaPhoneSquareAlt/>} />
                            </div>
                          </div>
